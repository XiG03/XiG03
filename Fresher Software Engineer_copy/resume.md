...
- **Frameworks & Libraries:** .NET Framework/Core, ASP.NET Core (MVC, Web API), ReactJS
...
### [TPS - Learning Management System](https://github.com/XiG03/TPS_FullStack) *(April 2026 – July 2026)*
**Live Demo:** tps-dyh9fbfug0ehdzf9.japanwest-01.azurewebsites.net 

**TechStack:** ASP.NET Core 8 (Web API), ADO.NET, SQL Server, JWT, ASP.NET Core Identity, Docker, GitHub Actions, Azure Web App, ReactJS.
...
### [Spa Booking & Management System](https://github.com/XiG03/SpaBookingWeb) *(Dec 2025 – June 2026)*

**Role:** Team Lead / Software Engineer

**Live Demo:** https://spabookingwebsite-d3bnc9d8f6b4bab9.japanwest-01.azurewebsites.net

**TechStack:** ASP.NET Core 8 (MVC, Web API), Entity Framework Core, SQL Server, ASP.NET Core Identity, Docker, Azure, Razor Pages.
